  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex w-[45%] bg-stone-900 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 -right-16 w-48 h-48 bg-amber-800/20 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="relative">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-amber-500 to-amber-700 rounded-xl flex items-center justify-center text-xl shadow-lg">
              🃏
            </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-[#f7f5f2] dark:bg-stone-900">
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-8 lg:hidden">
            <div className="w-14 h-14 bg-gradient-to-br from-amber-500 to-amber-700 rounded-2xl flex items-center justify-center text-2xl mx-auto mb-3 shadow-lg">
              🃏
            </div>
            <h1 className="text-2xl font-extrabold text-stone-900 dark:text-white tracking-tight">CardTracker</h1>
            <p className="text-sm text-stone-500 dark:text-stone-400 mt-1">Tu dashboard de cartas de colección</p>
          </div>

          {/* Card */}
          <div className="bg-white dark:bg-stone-800 rounded-2xl shadow-xl border border-stone-100 dark:border-stone-700 p-8">
