      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div className="flex gap-2 flex-1">
          <input
            ...
            className="flex-1 sm:max-w-64 border border-stone-200 dark:border-stone-600 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-400 dark:bg-stone-700 dark:text-stone-100 dark:placeholder-stone-500"
          />
          <select
            value={sort}
            onChange={e => setSort(e.target.value)}
            className="border border-stone-200 dark:border-stone-600 rounded-lg px-2 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-400 dark:bg-stone-700 dark:text-stone-100"
          >
        ...
        <div className="text-sm text-stone-500 dark:text-stone-400 font-medium whitespace-nowrap flex gap-4">
